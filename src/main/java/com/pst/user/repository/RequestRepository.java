...
public interface RequestRepository extends JpaRepository<RequestEntity, Long> {
	...
	// Used to filter certificates based on locations
	List<RequestEntity> findByCountryAndStateAndDistrictAndMandalAndVillage(String country, String state,
			String district, String mandal, String village);

	List<RequestEntity> findByCountryAndStateAndDistrictAndMandal(String country, String state, String district,
			String mandal);

	List<RequestEntity> findByCountryAndStateAndDistrict(String country, String state, String district);

	List<RequestEntity> findByCountryAndState(@Param("country") String country, @Param("state") String state);

	List<RequestEntity> findByCountry(String country);
